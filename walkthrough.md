...
- [x] 실제 개발 카카오 회원 세션으로 로그인 후 회원 홈, 동문 주소록 범위·검색, `/events` 유형 전환·문자 분석·자동저장·새로고침 후 유형별 초안 복구·삭제를 확인했다. QA용 기타 경조사 초안은 게시하지 않고 삭제했으며 `community_events`는 0건으로 복구했다.
