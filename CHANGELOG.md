...
- [진행 중, 카카오 심사 중] 카카오 동의항목 심사 가이드, 개인정보 없는 운영 로그인 화면 캡처와 심사용 PDF
...
경조사 통합 기반과 등록·초안 UI는 코드·Replit 검증 단계이며, 마이그레이션 SQL은 자동 실행되지 않는다. 카카오 동의·탈퇴 변경은 현재 HEAD 전체 Replit 자동화, 실제 개발 OAuth·명부 매칭·탈퇴, 운영 로그인 화면 캡처, 심사용 PDF, 운영 additive 스키마·Republish·비로그인 smoke·국외이전 고지와 카카오 심사 접수까지 확인했다. 운영 앱 개인정보 권한 심사 승인과 승인 후 운영 OAuth·탈퇴는 아직 남아 있다. 기존 부고 기본 기능의 프로덕션 검증 이력과 공개 `/about/condolence`는 유지한다.
