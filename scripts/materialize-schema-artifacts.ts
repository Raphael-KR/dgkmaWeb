...
const activeManifest = readManifest();
const lineage = activeManifest.value.manifest_lineage as { parent_manifest_path?: unknown; parent_manifest_sha256?: unknown };
if (typeof lineage?.parent_manifest_path !== "string" || typeof lineage.parent_manifest_sha256 !== "string") throw new Error("schema_artifact_parent_manifest_missing");
const manifest = readManifest(lineage.parent_manifest_path);
if (manifest.sha256 !== lineage.parent_manifest_sha256) throw new Error("schema_artifact_parent_manifest_mismatch");
