...
import { verifyStartupSchema } from "./startup-schema";
...
(async () => {
  try {
    ...
    log("database schema ledger verified through sequence 120");
    ...
    console.error(`FATAL: database schema ledger verification failed: ${err.message}`);
    process.exit(1);
  }
