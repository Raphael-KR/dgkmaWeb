...
const plan: GroupMultiBatchApplyPlan = {
  ...
  resolvedBindings: { bankAccountId: "1", bankAccountCode: "TOSS_OFFICER_2026", batchIdsByUid:{"11111111-1111-4111-8111-111111111111":"5","22222222-2222-4222-8222-222222222222":"6"}, decisionSetIdsByUid:{"33333333-3333-4333-8333-333333333333":"7","44444444-4444-4444-8444-444444444444":"8"}, rosterBatchIdsByUid: { "22222222-2222-4222-8222-222222222222": "6" }, eventPartyIdsByUid: { "55555555-5555-4555-8555-555555555555": null }, memberIdsByUid: { "66666666-6666-4666-8666-666666666666": "9" }, categoriesByCoordinate: { "bank:toss:1": { DUES_INCOME: { id: "7", displayName: "회비 수입" } } }, periodIdsByCoordinate: { "bank:toss:1": "8" }, financialDigestsByCoordinate: { "bank:toss:1": { rowFingerprint: "a".repeat(64), snapshotDigest: "b".repeat(64), payerDigest: "c".repeat(64), descriptionDigest: "d".repeat(64) } } },
  groups: [{
    primaryCoordinateKey: "bank:toss:1", eventPartyUid: "55555555-5555-4555-8555-555555555555", receiptUid: "77777777-7777-4777-8777-777777777777", rosterBatchUid: "22222222-2222-4222-8222-222222222222", classificationKind: "dues", classificationDecisionPayloadSha256: "3".repeat(64), duesYear: 2025, duesAmount: "50000", approvedAllocationAmount: "50000", categorySplits: [{ categoryCode: "DUES_INCOME", amount: "50000" }], eventAmount: "50000", occurredAt: "2026-01-01T00:00:00+09:00", postedDate: "2026-01-01",
