...
test("loads and locks the exact live companion graph before planning", async () => {
  ...
  const primaryWithEvidence = structuredClone(primary); primaryWithEvidence.items[0].evidence = { decisionItemId: "19", coordinateId: "29", sourceRowVersionId: "39", contentDigest, normalizationVersion: "bank-row-v1@1.0.0", normalizedPayload: { amount: "100000", balance_after: "100000", direction: "credit", occurred_at: "2026-01-01T00:00:00+09:00", payer_name_key_digest: "a".repeat(64), posted_date: "2026-01-01", provider_row_id: "row-1", transaction_description_digest: "b".repeat(64) } };
