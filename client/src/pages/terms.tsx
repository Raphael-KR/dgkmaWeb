          ...
          <CardContent className="space-y-8">
            ...
            <section>
              ...
              <div className="space-y-2 text-gray-700">
                ...
                <ul className="list-disc list-inside ml-4 space-y-1">
                  <li>필수정보: 이름, 휴대전화번호, 이메일</li>
                  <li>선택정보: 프로필 사진, 생일·생일 유형·윤달 여부, 카카오톡 채널 추가 상태 및 내역</li>
                </ul>
                <p>③ 회원 인증은 카카오 OAuth를 통해 진행되며, 카카오 회원번호는 동의항목과 구분되는 로그인 내부 연결 식별자로 서버에서 처리됩니다.</p>
                ...
                <p>⑤ 프로필 사진은 내 정보 표시에, 생일은 생일 당일 본인 전용 인앱 축하 화면 제공에 사용합니다. 카카오톡 채널 추가 상태 및 내역은 동문회 공지 및 경조사 알림 수신을 위한 공식 채널 추가와 채널 관계 확인에 사용합니다. 선택정보에 동의하지 않아도 가입할 수 있습니다.</p>
            ...
            <section>
              ...
              <div className="space-y-2 text-gray-700">
                <p>본 약관은 2026년 7월 12일부터 시행됩니다.</p>
              </div>
            </section>
