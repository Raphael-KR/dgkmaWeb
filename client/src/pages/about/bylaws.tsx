    ...
    <PublicLayout>
      <div className="max-w-3xl mx-auto px-4 py-10 sm:py-14">
        ...
        <article className="tp-prose">
          ...
          <h3>제4조 (회원의 자격)</h3>
          <ul>
            <li><strong>정회원</strong>: 동국대학교 한의과대학을 졸업한 자</li>
            <li><strong>준회원</strong>: 동국대학교 한의과대학 재학생 및 수료생</li>
            <li><strong>명예회원</strong>: 전·현직 교수 및 본회가 인정한 인사</li>
          </ul>
          <h3>제5조 (권리와 의무)</h3>
          <ol>
            <li>정회원은 총회 의결권, 임원 선거권 및 피선거권을 가진다.</li>
          ...
          <h2>제4장 회의</h2>
          <h3>제8조 (총회)</h3>
          <p>정기총회는 매년 1회 개최하며, 임시총회는 회장이 필요하다고 인정하거나 이사회 또는 정회원 1/5 이상의 요구가 있을 때 소집한다.</p>
          <h3>제9조 (의결)</h3>
