            ...
            <section>
              ...
              <div className="space-y-2 text-gray-700">
                ...
                <ul className="list-disc list-inside ml-4 space-y-1">
                  ...
                  <li>권리회원 대상 생일 축하 쿠폰의 카카오톡 발송</li>
                  <li>동문 간 네트워킹 지원</li>
                </ul>
              </div>
            </section>
              ...
              <div className="space-y-4 text-gray-700">
                <div>
                  ...
                  <ul className="list-disc list-inside ml-4 space-y-1">
                    ...
                    <li>※ 카카오 회원번호·성명·프로필 이미지·이메일·휴대전화번호·생일은 카카오 계정 연동을 통해 자동 수집됩니다 (제3조 ② 참조). 성명은 카카오 <code>kakao_account.name</code>에서 수집하며 별도 입력폼에서 받지 않습니다. 카카오 닉네임은 수집하지 않습니다. CI는 카카오 디벨로퍼스 [개인정보 동의항목] 심사 통과 후 추가 수집됩니다.</li>
                ...
                <div>
                  ...
                  <ul className="list-disc list-inside ml-4 space-y-1">
                    <li>카카오 계정 ID, 성명, 프로필 이미지</li>
                    <li>이메일 주소 (필수 동의)</li>
                    <li>휴대전화번호 (필수 동의) — 졸업생 명부 매칭 식별자</li>
                    <li>생일(MMDD)·생일 유형(양력/음력)·음력 윤달 여부 (선택 동의) — 권리회원 대상 생일 축하 쿠폰 발송 목적</li>
                    <li>※ 생일 정보 제공에 동의하지 않아도 회원가입은 가능하지만, 생일 축하 쿠폰 발송 대상에서는 제외됩니다.</li>
                    <li>※ 본 서비스는 휴대전화번호 제공에 동의한 카카오계정 사용자만 가입할 수 있습니다. 휴대전화번호를 제공할 수 없거나 동의하지 않는 경우 가입이 제한됩니다.</li>
                    <li>※ 카카오 닉네임은 수집하지 않습니다.</li>
                    <li>※ 추가 수집 예정 (카카오 디벨로퍼스 개인정보 동의항목 심사 통과 후 활성화):</li>
                    <li>· CI(연계정보) — 본인확인기관의 본인확인 서비스를 대체하기 위한 용도가 아니라, 동일 회원의 중복 가입 방지를 위한 내부 비교식별 목적으로만 사용합니다.</li>
                  </ul>
                </div>
                <div>
