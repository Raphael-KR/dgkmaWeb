          ...
          <CardContent className="space-y-8">
            ...
            <section>
              ...
              <div className="space-y-2 text-gray-700">
                ...
                <ul className="list-disc list-inside ml-4 space-y-1">
                  <li>회원 탈퇴 요청은 개인정보 관련 문의처로 접수하며, 계정 정보와 카카오 연동 정보를 삭제합니다. 다만 법령에 따른 보존 의무가 있는 정보는 해당 기간 동안 보관합니다.</li>
                  <li>결제 관련 정보: 관련 법령에서 정한 보존기간 동안 보관합니다.</li>
                </ul>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="space-y-4 text-gray-700">
                ...
                <div>
                  ...
                  <ul className="list-disc list-inside ml-4 space-y-1">
                    <li>필수: 카카오 회원번호, 이름, 이메일 주소, 휴대전화번호</li>
                    <li>선택: 프로필 이미지</li>
