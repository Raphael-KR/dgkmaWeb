...
| Todo 20 현재 단위 | strict payload/live-service, 48개 reason, 25-code exception, KST rights·close/balance·62-class lock trace 완료. `cfb17a0` registry disposable에 이어 `2d8d445`가 기존 legacy service로 receipt 5/entity 6/slot 16의 stored payload·hash·result equality와 same-UID replay sequence 불변, ROLLBACK·Development digest 불변·DB absence를 증명; transaction race와 나머지 workflow 전체 harness가 남음 |
