...
| Development source/import state | verified: logical source 10, active release 23 (`v1=10`, admin-readable `v2=10`, source amendments `v3=2`, Notion generation-evidence `v4=1`); import batch/decision set/item `5/5/3550`; all previews coordinate/version/link `3566/3566/3566`; preview operation receipt/entity/audit `5/14258/14258`; downstream/source-linked policy/period row `0/0/0`; all reruns `verified_noop`, verifier terminal `ROLLBACK` |
