...
| Development source/import state | verified read-only at `2026-08-11 10:03 KST`: logical source 10, active release 27 (`v1=10`, `v2=10`, `v3=6`, `v4=1`); import batch/decision set/item `9/9/6994`; batch/set `7/7 applied/approved`, AGM36 and foreign-faculty `2/2 previewed`; open period 4; association member/match candidate/position/classification/event/receipt/allocation rows all 0; source-decision apply operation receipt/entity/audit `7/18/18`; transaction terminal `ROLLBACK` |
