...
| Development source/import state | verified: logical source 10, active release 23 (`v1=10`, admin-readable `v2=10`, source amendments `v3=2`, Notion generation-evidence `v4=1`); import batch/decision set/item `4/4/3548`; all previews coordinate/version/link `3564/3564/3564`; preview operation receipt/entity/audit `4/14248/14248`; downstream/source-linked policy row `0/0`; all reruns `verified_noop`, verifier terminal `ROLLBACK` |
