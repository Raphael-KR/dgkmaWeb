...
| Development source/import state | verified read-only at `2026-08-11 08:01 KST`: logical source 10, active release 27 (`v1=10`, `v2=10`, `v3=6`, `v4=1`); import batch/decision set/item `9/9/6994`, all batch/set states `previewed`; coordinate/version/link `6984/6984/6984`; preview operation receipt/entity/audit `9/27964/27964`; association member/match candidate/position/classification/event/receipt/allocation rows all 0; transaction terminal `ROLLBACK` |
