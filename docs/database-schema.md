...
| Development source/import state | verified: logical source 10, active release 20 (`v1=10`, admin-readable `v2=10`); import batch/decision set/item `1/1/0`; first policy preview coordinate/version/link `10/10/10`; preview operation receipt/entity/audit `1/32/32`; downstream/source-linked policy row `0/0`; verifier terminal `ROLLBACK` |
