...
| Todo 22 measured restore verification KST | `2026-08-11 23:56 KST +0900` |
...
| Todo 22 restore evidence | exact commit `07b7927645d2ca8e988adc29a6d2fbb48cd80e68`에서 full test `425 pass/0 fail/2 skip`, typecheck, build, manifest/catalog/ledger와 Development→disposable custom dump/restore를 검증했다. Same-snapshot target-neutral schema/data/security SHA-256은 각각 `1bd252019300834e4d7dc575b49184f547d8bb20a58e47773ab16b8942dd3621` / `b1bd134ab285f75b59baebf8817cce4020b4ffc56b191318018f0b6f8c975219` / `b5f9dcec1959fa3b225b75d539bb2bf69454345fc73252a72729acd253fcd5da`로 일치했다. Restore-only reconcile은 checksum-bound exact ACL/default-privilege allowlist만 실행했으며 application schema/ledger를 변경하지 않았다. dump/disposable은 삭제 후 부재, Production은 credential 미사용으로 unverified·0 calls다. |
